...
var A, B, C, D, DATA, DELAY, DIST, FILENAME, HEIGHT, MAIL, SCALE, TRACKED, WIDTH, buttons, controls, corner, currentControl, cx, cy, drawButtons, drawControl, drawTrack, gps, gpsLat, gpsLon, hortal, img, initSpeaker, locationUpdate, locationUpdateFail, makeCorners, messages, mousePressed, myMousePressed, myround, playSound, position, preload, say, sayBearing, sayDistance, sendMail, setTarget, setup, show, showSpeed, soundDown, soundIndicator, soundQueue, soundUp, spara, speaker, timeout, track, trgLat, trgLon, vercal, xdraw;
...
setup = function setup() {
  ...
  buttons.push(new Button('T', (x + x2) / 2, (y + y2) / 2, function () {
    var d;
    d = new Date();
    return sendMail(currentControl + ' ' + gpsLat + ' ' + gpsLon + ' ' + d.toISOString());
  }));
