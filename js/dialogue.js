...
Dialogue = function () {
  ...
  _createClass(Dialogue, [{
    ...
    value: function list(lst) {
      ...
      this.add(new RectButton(['Prev'], 0 * w / 3, h * n, w / 3, h, function () {
        return this.dlg.update(-1);
      }));
      this.add(new RectButton(['Cancel'], 1 * w / 3, h * n, w / 3, h, function () {
        if (this.dlg.backPop) {
          return dialogues.pop();
        } else {
          return dialogues.clear();
      ...
      return this.add(new RectButton(['Next'], 2 * w / 3, h * n, w / 3, h, function () {
        return this.dlg.update(+1);
      }));
    }
  }, {
